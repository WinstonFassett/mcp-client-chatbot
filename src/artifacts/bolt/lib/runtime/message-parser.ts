import type { ActionType, BoltAction, BoltActionData, FileAction, ShellAction, SupabaseAction } from '@/artifacts/bolt/types/actions';
import type { BoltArtifactData } from '@/artifacts/bolt/types/artifact';
