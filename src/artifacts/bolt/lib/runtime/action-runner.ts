...
import { path as nodePath } from '@/artifacts/bolt/utils/path';
import { atom, map, type MapStore } from 'nanostores';
import type { ActionAlert, BoltAction, DeployAlert, FileHistory, SupabaseAction, SupabaseAlert } from '@/artifacts/bolt/types/actions';
...
import type { BoltShell } from '@/artifacts/bolt/utils/shell';
